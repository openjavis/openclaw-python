...
class BedrockProvider(LLMProvider):
    ...
    def __init__(self, model: str, region: Optional[str] = None, **kwargs):
    ...
    def _format_messages_for_bedrock(self, messages: list[LLMMessage]) -> tuple[Optional[str], list[dict]]:
